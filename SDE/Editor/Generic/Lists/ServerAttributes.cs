...
namespace SDE.Editor.Generic.Lists {
	public sealed class ServerItemAttributes : DbAttribute {
        ...
        public static readonly DbAttribute ArmorLevel = new ServerItemAttributes(new DbAttribute("ArmorLv", typeof(string), "", "Armor Level")) { Description = "Sets the armor level." };
        ...
        public static readonly DbAttribute Gradable = new ServerItemAttributes(new DbAttribute("Grada", typeof(bool), "", "Gradable")) { DataConverter = ValueConverters.GetBooleanSetGradableString, Description = "Defines wheter or not the equipment can be gradable (the value is ignored for other item types)." };
